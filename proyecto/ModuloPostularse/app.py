...
usuario = Usuario ('Persona', 12345, '1234')
...
postulacion = Postulacion('Ecopetrol', 'Vacantes = 5', 'postulaciones = 10', 'fecha de inicio = 10/05/2023', 'Fecha de cierre = 20/07/2023', 'Experiencia laboral de un año', 'situacion ocupacional: Desempleado', 'Tecnologo en Analisis y desarrollo de sofware', 'Salario minimo legal vigente', 'Contrato indefinido', 'Postulacion Abierta')
...
print(postulacion.comparar_cadidato_oferta())
